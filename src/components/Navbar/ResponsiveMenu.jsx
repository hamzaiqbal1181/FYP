...
// File: src/components/Navbar/ResponsiveMenu.jsx (Complete Updated Version)
  ...
  return (
    <>
      ...
      >
              ...
              {NavbarLinks.map((item) => (
                ...
                >
                  {item.submenu ? (
                    <div>
                      <button
                        className="group flex items-center justify-between gap-2 w-full text-left px-3 py-2 rounded-md transition-colors duration-200 hover:bg-sky-100 hover:text-sky-600"
                        onClick={() =>
                          setOpenDropdown(
                            openDropdown === item.name ? null : item.name
                          )
        ...
        {/* Footer section with Quote and Auth Button */}
        <div className="flex items-center justify-between gap-4">
          {/* Quote */}
          <div className="text-left w-2/3">
            <p className="italic text-gray-800 text-sm font-semibold">
              "Travel is the only thing you buy that makes you richer."
            </p>
          </div>
          ...
          <div className="w-1/3">
            {currentUser ? (
              <button
                ...
                className="block w-full text-center bg-red-500 text-white px-3 py-2 rounded-full text-sm font-semibold hover:bg-red-600 transition-colors"
              >
                Sign Out
              </button>
            ) : (
              <Link
                to="/signin"
                onClick={() => setShowMenu(false)}
                className="block w-full text-center bg-sky-500 text-white px-3 py-2 rounded-full text-sm font-semibold hover:bg-sky-600 transition-colors"
              >
                Sign In
              </Link>
            )}
