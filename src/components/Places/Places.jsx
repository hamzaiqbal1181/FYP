...
//     location: "Lahore",
//     description:
//       "The Lahore Fort, or Shahi Qila, boasts a history as rich and layered as its intricate architecture, with its origins tracing back to antiquity, though definitive records begin with the Ghaznavids. The earliest fortified structure on this site is believed to have been a mud-brick fort from the 11th century, razed and rebuilt multiple times by various rulers. The fort’s foundational transformation began in 1566 under the great Mughal Emperor Akbar, who ordered the demolition of the old mud fort and the construction of a much grander structure using burnt bricks and red sandstone. Akbar’s design laid the sprawling complex's basic layout, emphasizing defensive strength and imperial grandeur. Subsequent Mughal emperors each added their unique architectural signatures. Jahangir introduced the Picture Wall, adorned with vibrant tile-mosaics depicting court life and mythical creatures, and built the Moti Masjid (Pearl Mosque). However, it was Shah Jahan, the builder of the Taj Mahal, who truly imbued the fort with unparalleled elegance. He replaced many of Akbar's red sandstone structures with gleaming white marble pavilions, including the exquisite Sheesh Mahal (Palace of Mirrors) and the Naulakha Pavilion, famed for its delicate pietra dura work. His contributions represent the zenith of Mughal architecture within the fort. Aurangzeb, his successor, added the monumental Alamgiri Gate, the fort's magnificent western entrance, perfectly aligned with the Badshahi Mosque. Following the decline of the Mughals, the fort saw periods under Sikh and British rule. The Sikhs, particularly Maharaja Ranjit Singh, made several additions and alterations, though some were at the expense of earlier Mughal structures. The British later used the fort as a cantonment and made their own modifications. Today, the Lahore Fort stands as a UNESCO World Heritage site, a captivating chronicle of Pakistan's imperial past, showcasing a seamless blend of Islamic, Hindu, and Sikh architectural influences across its formidable walls and opulent palaces.",
//     type: "Historical",
//     mapUrl:
...
//     location: "Lahore",
//     description:
//       "Minar-e-Pakistan, located in Lahore, commemorates the Lahore Resolution of 1940, when the demand for a separate nation for Muslims in India was made. This iconic tower, built in 1966, stands 70 meters tall and showcases a blend of Islamic and modern architectural styles. Surrounded by a beautiful park, Minar-e-Pakistan serves as a national symbol of pride and unity for Pakistanis, attracting countless visitors each year who come to admire its significance and beauty. Ascending its heights, whether by elevator or the winding staircase, offers a unique perspective – not just of the sprawling city of Lahore, but of the very journey of a nation. From its pinnacle, the bustling metropolis unfolds beneath, a vibrant testament to the dreams realized. The monument stands on the very site where the Lahore Resolution was passed in 1940, a pivotal moment that irrevocably set the course for an independent Muslim state. It's a place where history breathes, where the sacrifices of millions feel palpable, and where the promise of a sovereign future was first declared. Minar-e-Pakistan is not merely a tourist attraction; it's a pilgrimage for the soul, a place of reflection and inspiration. It stands as a perpetual reminder of identity, resilience, and the power of a collective dream. To visit is to connect with the very essence of Pakistan, to feel the echoes of its founding fathers, and to witness a monument that truly embodies the spirit of a nation",
//     type: "Historical",
//     mapUrl:
...
//     location: "Lahore",
//     description:
//       "The Badshahi Mosque, built in 1673, is a grand Mughal masterpiece located in Lahore, Pakistan. It is renowned for its stunning red sandstone and intricate marble inlay, representing the zenith of Mughal architecture. With a capacity to accommodate over 55,000 worshippers, it's one of the largest mosques in the world and a symbol of religious and cultural heritage. The mosque features a beautiful courtyard, soaring minarets, and rich history, making it a must-visit landmark. Inside the main prayer hall, a different kind of splendor unfolds. The pristine white marble gleams, adorned with exquisite fresco work, delicate floral patterns, and verses from the Quran etched with masterful precision. The acoustics are legendary, allowing the Imam's voice to resonate with powerful clarity throughout the vast space, creating an immersive spiritual experience. From the intricate inlay work to the soaring domes, every detail speaks of unparalleled craftsmanship and a deep reverence for beauty. The Badshahi Mosque is not just a historical site or a architectural wonder; it is a spiritual heart of Lahore, a place where history, faith, and art merge seamlessly. To stand within its walls is to connect with centuries of devotion, to marvel at human ingenuity, and to witness a monument that truly embodies the timeless elegance and profound faith of its creators. It's an unforgettable journey into the soul of a city and a nation.",
//     type: "Historical",
//     mapUrl:
...
//     location: "Lahore",
//     description:
//       "Shalimar Garden in Lahore, built during the Mughal era, is a stunning example of Persian garden design. Established in the 17th century by Emperor Shah Jahan, it features magnificent terraced levels, flowing water channels, and vibrant flora. The garden symbolizes the grandeur of Mughal architecture and serves as a peaceful retreat. Its historical significance and beauty attract numerous visitors each year, making it a cherished heritage site. The gardens are laid out in three descending terraces, each with a specific name and purpose: the upper terrace called Fara Bakhsh (Bestower of Pleasure), the middle terrace Faiz Bakhsh (Bestower of Goodness), and the lower terrace also Faiz Bakhsh. These terraces were not just for aesthetic appeal; they symbolized different levels of paradise. Over 400 fountains once gushed water, creating a cool microclimate and a soothing auditory experience, a stark contrast to the Lahori heat. While primarily a royal pleasure garden, the Shalimar Bagh also served as a venue for state receptions and festivities during the Mughal era. After the decline of the Mughals, the gardens faced periods of neglect and alteration under Sikh rule, with some of its precious marble being plundered. The British later made efforts towards restoration. Today, the Shalimar Bagh remains a UNESCO World Heritage site, celebrated for its exquisite layout, sophisticated waterworks, and the profound sense of tranquility it offers. It stands as a timeless testament to Mughal artistry, engineering prowess, and their enduring vision of an earthly paradise.",
//     type: "Historical",
//     mapUrl:
...
//     location: "Lahore",
//     description:
//       "Sheesh Mehal in Lahore, also known as the Sheesh Mahal, is a stunning example of Mughal architecture. It was constructed in the 17th century for the Mughal Emperor Shah Jahan. The palace is adorned with intricate mirror work, reflecting beautiful patterns and designs. It served as a serenity retreat for the royal family, showcasing the grandeur of its time. Its unique beauty and historical significance make Sheesh Mehal a captivating destination for visitors today. The palace derives its name from the intricate mosaic work of myriad tiny, convex mirrors embedded into the white marble walls and ceilings. These mirrors were meticulously set in complex geometrical and floral patterns, designed to reflect and multiply even the faintest glimmer of light – from a single candle to the moonlight – creating an illusion of a thousand stars twinkling within the chamber. The effect was magical, designed to mesmerize and enchant. Beyond the mirrors, the interior is richly decorated with fresco work, gilt ornamentation, and marble screens ('jali') with exquisite carving. The Sheesh Mahal also features the famous marble baradari or pavilion, which offers panoramic views of the fort's courtyard and the surrounding areas. Over time, the palace suffered from neglect and natural decay, particularly during the Sikh and British periods. However, extensive conservation efforts in the 20th and 21st centuries have aimed to restore its original grandeur, allowing visitors today to marvel at its astonishing beauty and the ingenious craftsmanship of its Mughal creators. It remains one of the most celebrated and iconic structures within the Lahore Fort",
//     type: "Historical",
//     mapUrl:
...
//     location: "Lahore",
//     description:
//       "Often called a mole on the cheek of Lahore, the Wazir Khan Mosque is a jewel box of vibrant color. Built in the 17th century during Emperor Shah Jahan's reign by his governor, Wazir Khan, it is a masterpiece of Mughal architecture. Its most unique feature is the breathtaking kashi-kari (faience tile work) that covers nearly every surface, inside and out. These intricate floral and calligraphic mosaics make it one of the most ornately decorated mosques in the world. The mosque is celebrated for its extensive and vibrant fresco and tile work ('kashi-kari'), which distinguishes it from almost all other Mughal monuments. Its walls, domes, and minarets are adorned with intricate floral motifs, calligraphy, and geometric patterns in rich blues, greens, yellows, and oranges, showcasing a masterful blend of Persian and local Mughal architectural styles. The faience tile work is particularly notable, considered some of the finest examples from the Mughal period. The mosque's plan includes a large central courtyard with a ablution pool, surrounded by arcades. Four octagonal minarets grace its corners, adding to its majestic appearance. Beyond its religious function, the Wazir Khan Mosque was conceived as part of a larger complex that included shops, a caravanserai, and a hammam (bathhouse), the revenues from which were intended to maintain the mosque. This integrated urban planning made it a bustling center of religious, commercial, and social activity. Today, the Wazir Khan Mosque continues to be an active place of worship and a major tourist attraction, meticulously preserved to showcase its breathtaking artistic heritage. Its vivid decoration and historical significance offer a profound glimpse into the cultural and religious landscape of 17th-century Lahore.",
//     type: "Historical",
//     mapUrl:
...
//     location: "Lahore",
//     description:
//       "Lahore Railway Station, built in 1860, is a historical landmark showcasing stunning Indo-Saracenic architecture. This bustling hub connects travelers to various destinations across Pakistan. The station features a remarkable clock tower and vibrant platforms, reflecting the city’s cultural heritage. Its location near the heart of Lahore makes it accessible, attracting both locals and tourists. As one of the busiest railway stations, it plays a pivotal role in the transportation network of the region, it was one of the earliest and largest railway stations built in British India, part of the extensive railway network that connected major cities. Designed in a medieval-inspired, fortress-like style, complete with defensive turrets and loopholes, it was built to withstand potential attacks, particularly after the 1857 Indian Rebellion. It quickly became a crucial hub for passenger and goods traffic, linking Lahore to Delhi, Amritsar, and Karachi, and played a significant role in the region's economic and social development.",
//     type: "Historical",
//     mapUrl:
...
//     location: "Lahore",
//     description:
//       "Zoo Lahore, established in 1872, is one of the oldest zoos in the world, located in Lahore, Pakistan. It covers 38 acres and houses over 1,500 animals from various species. The zoo aims to promote conservation and education, providing an enjoyable experience for visitors. With attractions like the elephant pond and children's petting area, it serves as an engaging venue for families and wildlife enthusiasts.  Originally founded by the British colonial administration, it began as a small menagerie and gradually expanded its collection of indigenous and exotic animals. Over its long history, it has served as a recreational and educational facility, evolving from a simple animal display to an institution focused on conservation, breeding programs, and public awareness about wildlife.",
//     type: "Historical",
//     mapUrl:
...
//     location: "Lahore",
//     description:
//       "Shahi Hammam in Lahore, a historic Mughal bathhouse, showcases exquisite architecture and intricate tile work, reflecting the grandeur of the Mughal era. Established in the 16th century, it served as a lavish relaxation site for royalty. This unique structure features heated water systems, beautifully decorated domes, and serene ambiance, making it a significant cultural landmark. Today, Shahi Hammam stands as a testament to Lahore's rich heritage, attracting visitors who admire its beauty and historical importance. Located near Delhi Gate, the Shahi Hammam is a well-preserved Mughal-era public bathhouse. Built in 1635 CE by Ilam-ud-din Ansari (Wazir Khan), the governor of Lahore under Emperor Shah Jahan, it was designed for travelers and residents of the Walled City. It comprised various sections for hot baths, cold baths, and steam baths, adorned with beautiful frescoes. It reflects Mughal engineering and hygiene practices, serving as a social and cleansing hub.",
//     type: "Historical",
//     mapUrl:
...
//     location: "Lahore",
//     description:
//       "The Lahore Museum, established in 1865, boasts an extensive collection showcasing Pakistan's rich history, artifacts, and art. Its stunning architecture and diverse exhibits attract history enthusiasts and tourists alike. Highlights include Gandhara sculptures, Mughal art, and traditional textiles, all reflecting the region's cultural heritage. Lahore Museum is Pakistan's largest museum and one of the oldest. Housed in a magnificent red-brick building, it was designed by Sir Ganga Ram and is renowned for its vast collection of artifacts spanning millennia of South Asian history. Its exhibits include Gandhara Buddhist art, Mughal and Sikh paintings, Islamic manuscripts, and relics from the Indus Valley Civilization, making it a pivotal institution for preserving national heritage.",
//     type: "Historical",
//     mapUrl:
...
//     location: "Lahore",
//     description:
//       " Originally known as Lawrence Garden, Bagh-e-Jinnah was established in 1862 by the British, named after John Laird Mair Lawrence, a former Viceroy of India. This sprawling botanical garden and park served as a popular recreational area for the colonial elite and local populace. It features vast green spaces, a botanical garden, a mosque, and a library (Quaid-e-Azam Library). After Pakistan's independence, it was renamed Bagh-e-Jinnah in honor of the nation's founder, Muhammad Ali Jinnah, and remains a beloved public park and cultural hub. Bagh-e-Jinnah, located in Lahore, is a historic park famous for its vibrant gardens and rich history. Established during British colonial rule, it served as a recreational space for locals and visitors alike. The park is home to numerous historical monuments, including the Allama Iqbal Memorial, which honors the famous poet and philosopher. Its lush landscapes and serene atmosphere make it a perfect place for relaxation and cultural gatherings.",
//     type: "Historical",
//     mapUrl:
...
// import PlaceDetailPopup from "./PlaceDetailPopup";
// import MapPopup from "./MapPopup";
// import PlacesBanner from "./PlacesBanner";
...
// // --- Images for the new banners (you can replace these with more specific ones) ---
// // import HistoricalBanner from "../../assets/banners/historical_banner.jpg";
// // import ShoppingBanner from "../../assets/banners/shopping_banner.jpg";
// // import FoodBanner from "../../assets/banners/food_banner.jpg";
...
//   const isPlacesRoute = location.pathname === "/places";
...
//           <div id="historical">
//             <h2 className="my-8 ml-1 border-l-8 border-sky-700 py-2 pl-2 text-2xl font-bold">
//               Historical Places
//             </h2>
//             {isPlacesRoute && (
//               <PlacesBanner
//                 image={Img1}
//                 title="Uncover the Rich Tapestry of History"
//                 description="Step back in time and explore ancient forts, majestic mosques, and captivating gardens that tell tales of empires past. Each historical site offers a unique glimpse into the rich heritage and architectural brilliance of Lahore."
//               />
//             )}
//             <PlaceCategorySection
//               // No title prop needed here as we've rendered it above
//               places={historicalPlaces}
//               onLocationClick={handleLocationClick}
//             />
//           </div>
...
//               <PlacesBanner
//                 image={Img2}
//                 title="Shop 'til You Drop: From Bustling Bazaars to Modern Malls"
//                 description="Experience the thrill of shopping in Lahore! Discover traditional handicrafts, designer wear, and the latest electronics across vibrant bazaars and luxurious shopping malls."
//                 reverse={true}
//               />
//             )}
//             <PlaceCategorySection
...
//               <PlacesBanner
//                 image={Img3}
//                 title="A Culinary Journey: Savor the Flavors of Lahore"
//                 description="Indulge in Lahore's world-renowned food scene. From spicy street food to gourmet dining, embark on a gastronomic adventure that will tantalize your taste buds."
//               />
//             )}
//             <PlaceCategorySection
//               // No title prop needed here as we've rendered it above
...
// --- ALL YOUR IMAGE IMPORTS (still needed for individual place cards) ---
import Img1 from "../../assets/places/fort.jpg";
import Img2 from "../../assets/places/minarepakistan.jpg";
import Img3 from "../../assets/places/mosque.jpg";
import Img4 from "../../assets/places/shalimar.jpg";
      ...
      <div className="bg-gray-50 py-10">
        <div className="container mx-auto">
          ...
          <div id="historical">
            ...
            {isPlacesRoute && (
              <PlacesBanner
                videoPublicId="historic_lq5czn" // Replace with your Cloudinary Public ID for historical places
                title="Uncover the Rich Tapestry of History"
                description="Step back in time and explore ancient forts, majestic mosques, and captivating gardens that tell tales of empires past. Each historical site offers a unique glimpse into the rich heritage and architectural brilliance of Lahore."
              />
            )}
          ...
          <div id="shopping">
            ...
            {isPlacesRoute && (
              <PlacesBanner
                videoPublicId="Bazaar_oi6s93" // Replace with your Cloudinary Public ID for shopping places
                title="Shop 'til You Drop: From Bustling Bazaars to Modern Malls"
                description="Experience the thrill of shopping in Lahore! Discover traditional handicrafts, designer wear, and the latest electronics across vibrant bazaars and luxurious shopping malls."
                reverse={true}
              />
          ...
          <div id="food">
            ...
            {isPlacesRoute && (
              <PlacesBanner
                videoPublicId="food_h2twsr" // Replace with your Cloudinary Public ID for food points
                title="A Culinary Journey: Savor the Flavors of Lahore"
                description="Indulge in Lahore's world-renowned food scene. From spicy street food to gourmet dining, embark on a gastronomic adventure that will tantalize your taste buds."
              />
            )}
